...
inline int ssd1306_get_font(uint8_t character)
{
  if (character >= 'A' && character <= 'Z') {
    ...
    return 39; // Índice do caractere '/'
  }
  else if (character == '\\') {
    return 40; // Índice do caractere '\'
  }
  else if (character == '|') {
    return 41; // Índice do caractere '|'
  }
   else if (character == '.') {
    return 42; // Índice do caractere '.'
  }
  else if (character == '-') {
    return 43; // Índice do caractere '-'
  }
  else if (character == '>') {
    return 44; // Índice do caractere '>'
  }
  else if (character == 0x2192) { // Unicode value for '→'
    return 45; // Índice do caractere '→'
  }
  else {
